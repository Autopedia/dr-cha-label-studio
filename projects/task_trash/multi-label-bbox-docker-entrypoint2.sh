...
export PROJECT_NAME=task_multi_label_bbox2
export PORT=9002
...
--source-params "{\"use_blob_urls\": true, \"data_key\": \"image\", \"prefix\": \"data4ls/1111/images\", \"regex\": \"^.*.(jpeg|jpg|JPG|JPEG)\" }" \
--target gcs-completions --target-path garbage_v2 \
--target-params "{\"prefix\": \"data4ls/1111/outputs_2\", \"create_local_copy\": false}" \
--use-gevent